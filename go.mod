module github.com/bendaferi/customdagvm

go 1.18

replace github.com/ava-labs/avalanchego v1.7.18 => github.com/bendaferi/avalanchego v0.1.0
...
require (
	github.com/ava-labs/timestampvm v1.2.6
